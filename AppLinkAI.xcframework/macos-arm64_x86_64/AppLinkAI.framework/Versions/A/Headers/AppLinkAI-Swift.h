...
#ifndef APPLINKAI_SWIFT_H
#define APPLINKAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppLinkAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (NSString * _Nonnull)SourceUrlKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SourceUrlPathKey;)
+ (NSString * _Nonnull)SourceUrlPathKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SourceUrlQueryParamsKey;)
+ (NSString * _Nonnull)SourceUrlQueryParamsKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull IsFirstSessionKey;)
+ (NSString * _Nonnull)IsFirstSessionKey SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AppLink * _Nonnull shared;)
...
/// Resets the persisted data (such as IsFirstSessionKey, etc..)
- (void)reset;
